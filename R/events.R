...
#'
#' \code{fetch_events} downloads data on event metrics for a given
#' view during the given dates and returns the data as a tibble.
#'
...
#' @return A tibble of event metrics.
#' @export
